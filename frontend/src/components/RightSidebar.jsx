...
//         <h1 className="font-bold my-3 ">Who to follow</h1>
...
//               <p className="text-base text-gray-500">@karunaKarki</p>
//             </div>
//             <div className="ml-5">
//               <button className="bg-white text-black font-bold   px-4 py-1 text-lg  rounded-full ">
//                 Follow
//               </button>
//             </div>
//           </div>
